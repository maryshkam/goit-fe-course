...
const addLogin = function (loginArray, loginText) {
  if (isLoginValid(loginText)) {
    if (isLoginUnique(loginArray, loginText)) {
      loginArray.push(loginText);
      console.log('Логін успішно доданий!');
      // return logins;

    } else {console.log('Такий логін уже використовується!');}
