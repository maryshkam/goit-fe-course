...
const getAllNames = arr => {
  const nameUser = arr.map(element => element.name);
  return nameUser;
};
...
const getUsersByEyeColor = (arr, color) => {
  const userEyeColor = arr.filter(element => element.eyeColor === color);
  return userEyeColor;
};
...
const getUsersByGender = (arr, gender) => {
  // const result = [];
  const userGender = arr.filter(element => {
...
const getInactiveUsers = arr => {
 const userNoActive = arr.filter(element => !element.isActive);
 return userNoActive;
};
...
const getUserByEmail = (arr, email) => {
  const userMail = arr.find(element => element.email === email);
  return userMail;
};
...
const getUsersWithAge = (arr, min, max) => {
  const usersAge = arr.filter(element => element.age > min && element.age < max);
  return usersAge;
};
...
const getTotalBalance = arr => {
  const arrBalance = arr.map(element => element.balance)
...
const getUsersByFriend = (arr, name) => {
  const arrUserFriend = arr.filter(element => {
    if (element.friends.includes(name)) {
      return element;
    }
  }).map(element => element.name);
  return arrUserFriend;
};
...
const getAllUniqueSkills = arr => {
  // const skills = [];
  const arrAllSkills = arr.map(element => element.skills)
...
const getUserNamesSortedByFriendsCount = arr => {
  const userFriends = arr.sort((a, b) => a.friends.length - b.friends.length)
  .map(element => element.name);
  return userFriends;
